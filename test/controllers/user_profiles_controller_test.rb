...
class UserProfilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_profile" do
    assert_difference("UserProfile.count") do
      post user_profiles_url, params: { user_profile: { birthdate: @user_profile.birthdate, email: @user_profile.email, gender: @user_profile.gender, name: @user_profile.name, phone: @user_profile.phone, user_id: @user_profile.user_id } }
    end
  ...
  test "should update user_profile" do
    patch user_profile_url(@user_profile), params: { user_profile: { birthdate: @user_profile.birthdate, email: @user_profile.email, gender: @user_profile.gender, name: @user_profile.name, phone: @user_profile.phone, user_id: @user_profile.user_id } }
