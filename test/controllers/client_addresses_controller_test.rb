...
class ClientAddressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create client_address" do
    assert_difference("ClientAddress.count") do
      post client_addresses_url, params: { client_address: { address: @client_address.address, city: @client_address.city, client_id: @client_address.client_id, number: @client_address.number, reference: @client_address.reference, state: @client_address.state, zip: @client_address.zip } }
    end
  ...
  test "should update client_address" do
    patch client_address_url(@client_address), params: { client_address: { address: @client_address.address, city: @client_address.city, client_id: @client_address.client_id, number: @client_address.number, reference: @client_address.reference, state: @client_address.state, zip: @client_address.zip } }
